...
const cacheName = 'LAWKTreyGleason-2021-03-22 21:21:00.584918'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWKTreyGleason'.length) === 'LAWKTreyGleason') {
